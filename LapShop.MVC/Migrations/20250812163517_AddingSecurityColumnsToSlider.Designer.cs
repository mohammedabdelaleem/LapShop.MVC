...
namespace LapShop.MVC.Migrations
{
    ...
    [Migration("20250812163517_AddingSecurityColumnsToSlider")]
    partial class AddingSecurityColumnsToSlider
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LapShop.MVC.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "admin@lap-shop.com",
                            EmailConfirmed = true,
                            FirstName = "Survey Basket",
                            IsDisabled = false,
                            LastName = "Admin",
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@LAP-SHOP.COM",
                            NormalizedUserName = "ADMIN@LAP-SHOP.COM",
                            ...
                            UserName = "admin@lap-shop.com"
                        });
                });

            modelBuilder.Entity("LapShop.MVC.Models.TbBusinessInfo", b =>
                {
            ...
            modelBuilder.Entity("LapShop.MVC.Models.TbCashTransacion", b =>
                {
            ...
            modelBuilder.Entity("LapShop.MVC.Models.TbCategory", b =>
                {
            ...
            modelBuilder.Entity("LapShop.MVC.Models.TbItemImage", b =>
                {
            ...
            modelBuilder.Entity("LapShop.MVC.Models.TbSupplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.MVC.Models.VwItemCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.MVC.Models.VwSalesInvoice", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.MVC.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("LapShop.MVC.Models.TbBusinessInfo", b =>
                {
                    b.HasOne("LapShop.MVC.Models.TbCustomer", "Cutomer")
                        .WithOne("TbBusinessInfo")
                        .HasForeignKey("LapShop.MVC.Models.TbBusinessInfo", "CutomerId")
            ...
            modelBuilder.Entity("LapShop.MVC.Models.TbItem", b =>
                {
                    b.HasOne("LapShop.MVC.Models.TbCategory", "Category")
                        .WithMany("TbItems")
                        .HasForeignKey("CategoryId")
                        .IsRequired()
                        .HasConstraintName("FK_TbItems_TbCategories");

                    b.HasOne("LapShop.MVC.Models.TbItemType", "ItemType")
                        .WithMany("TbItems")
                    ...
                    b.HasOne("LapShop.MVC.Models.TbO", "Os")
                        .WithMany("TbItems")
                        .HasForeignKey("OsId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
            ...
            modelBuilder.Entity("LapShop.MVC.Models.TbItemDiscount", b =>
                {
                    b.HasOne("LapShop.MVC.Models.TbItem", "Item")
            ...
            modelBuilder.Entity("LapShop.MVC.Models.TbPurchaseInvoice", b =>
                {
                    b.HasOne("LapShop.MVC.Models.TbSupplier", "Supplier")
            ...
            modelBuilder.Entity("LapShop.MVC.Models.TbPurchaseInvoiceItem", b =>
                {
                    b.HasOne("LapShop.MVC.Models.TbPurchaseInvoice", "Invoice")
            ...
            modelBuilder.Entity("LapShop.MVC.Models.TbSalesInvoiceItem", b =>
                {
                    b.HasOne("LapShop.MVC.Models.TbSalesInvoice", "Invoice")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LapShop.MVC.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TbCustomerItem", b =>
                {
                    b.HasOne("LapShop.MVC.Models.TbCustomer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LapShop.MVC.Models.TbItem", null)
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
